      ...
      {jobs.map((job, _) => (
        <button className="my-2 px-4 lg:px-8 w-full" key={job.title}>
          <a href={job.jobPosting.applicationLink}>
            <div className="shadow-sm border border-slate-700 rounded-md w-full bg-blue-700 hover:bg-blue-900 transition duration-150 ease-in-out min-h-52 lg:h-72 text-left px-4 py-3 flex flex-col justify-around">
